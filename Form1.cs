...
namespace MathQuiz
{
    public partial class Form1 : Form
    {
        ...
        public void StartTheQuiz()
        {
            ...
            //Store the value in the variables 'addend1' and 'addend2'
            ...
            int temporaryQuotiend = randomizer.Next(2, 11);
            dividend = divisor * temporaryQuotiend;
        ...
        private void timeLabel_Click(object sender, EventArgs e)
        {
            ...
            {
                //if the user ran out time, stop the timer, show a message box, and fill in the answers.
                timer1.Stop();
